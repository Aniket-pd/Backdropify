...
// Conform to Identifiable and Equatable for use with .fullScreenCover(item:)
...
struct WallpaperPreviewView: View {
    ...
    var body: some View {
        ...
        .ignoresSafeArea()
        // Present the fullscreen wallpaper view when a wallpaper is selected
        .fullScreenCover(item: $selectedWallpaper) { wallpaper in
            FullscreenWallpaperView(wallpaper: wallpaper)
        }
